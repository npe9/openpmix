...
static pmix_status_t init(void)
{
    ...
    /* Match v4 registrations: v21 was missing these; client→server relay (e.g. topology
     * for PMIx_Compute_distances) uses PMIX_TOPO / PMIX_PROC_CPUSET and hit UNKNOWN_DATA_TYPE. */
    PMIX_REGISTER_TYPE("PMIX_IOF_CHANNEL", PMIX_IOF_CHANNEL, pmix_bfrops_base_pack_iof_channel,
                       ...
                       pmix_bfrops_base_print_iof_channel, &pmix_mca_bfrops_v21_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_ENVAR", PMIX_ENVAR, pmix_bfrops_base_pack_envar,
                       ...
                       pmix_bfrops_base_print_envar, &pmix_mca_bfrops_v21_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_COORD", PMIX_COORD, pmix_bfrops_base_pack_coord,
                       ...
                       pmix_bfrops_base_print_coord, &pmix_mca_bfrops_v21_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_REGATTR", PMIX_REGATTR, pmix_bfrops_base_pack_regattr,
                       ...
                       pmix_bfrops_base_print_regattr, &pmix_mca_bfrops_v21_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_REGEX", PMIX_REGEX, pmix_bfrops_base_pack_regex,
                       ...
                       pmix_bfrops_base_print_regex, &pmix_mca_bfrops_v21_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_JOB_STATE", PMIX_JOB_STATE, pmix_bfrops_base_pack_jobstate,
                       ...
                       pmix_bfrops_base_print_jobstate, &pmix_mca_bfrops_v21_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_LINK_STATE", PMIX_LINK_STATE, pmix_bfrops_base_pack_linkstate,
                       ...
                       pmix_bfrops_base_print_linkstate, &pmix_mca_bfrops_v21_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_PROC_CPUSET", PMIX_PROC_CPUSET, pmix_bfrops_base_pack_cpuset,
                       ...
                       pmix_bfrops_base_print_cpuset, &pmix_mca_bfrops_v21_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_GEOMETRY", PMIX_GEOMETRY, pmix_bfrops_base_pack_geometry,
                       ...
                       pmix_bfrops_base_print_geometry, &pmix_mca_bfrops_v21_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_DEVICE_DIST", PMIX_DEVICE_DIST, pmix_bfrops_base_pack_devdist,
                       ...
                       pmix_bfrops_base_print_devdist, &pmix_mca_bfrops_v21_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_ENDPOINT", PMIX_ENDPOINT, pmix_bfrops_base_pack_endpoint,
                       ...
                       pmix_bfrops_base_print_endpoint, &pmix_mca_bfrops_v21_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_TOPO", PMIX_TOPO, pmix_bfrops_base_pack_topology,
                       ...
                       pmix_bfrops_base_print_topology, &pmix_mca_bfrops_v21_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_DEVTYPE", PMIX_DEVTYPE, pmix_bfrops_base_pack_devtype,
                       ...
                       pmix_bfrops_base_print_devtype, &pmix_mca_bfrops_v21_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_LOCTYPE", PMIX_LOCTYPE, pmix_bfrops_base_pack_locality,
                       ...
                       pmix_bfrops_base_print_locality, &pmix_mca_bfrops_v21_component.types);
